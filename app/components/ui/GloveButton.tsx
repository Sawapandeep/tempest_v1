...
const GloveButton = forwardRef<HTMLButtonElement, GloveButtonProps>(
    (
        ...
        const variantClasses = {
            primary:
                "bg-tempest-cyan text-amoled-black font-bold hover:bg-tempest-cyan/90 active:bg-tempest-cyan/80",
            secondary:
                "glass text-white hover:bg-white/10 active:bg-white/5",
            danger:
                "bg-tempest-red text-white font-bold hover:bg-red-500 active:bg-red-600",
            ghost:
                "text-white/70 hover:text-white hover:bg-white/5 active:bg-white/10",
            outline:
                "border border-white/20 text-white hover:border-white/40 hover:bg-white/5",
            cyan:
                "bg-tempest-cyan/10 text-tempest-cyan border border-tempest-cyan/30 hover:bg-tempest-cyan/20 font-semibold",
            orange:
                "bg-tempest-orange/10 text-tempest-orange border border-tempest-orange/30 hover:bg-tempest-orange/20 font-semibold",
        };
